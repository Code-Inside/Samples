param([string]$Subdomain="blogpostsample", [string]$SiteName = "blogpostsample", [string]$SitePhysicalPath, [string]$MakeCertPath, [string]$AppCmdPath)
...
if(!$SitePhysicalPath) {
    ...
    $SitePhysicalPath = Join-Path $ScriptRoot ".\MicrosoftAccountDemo"
}
