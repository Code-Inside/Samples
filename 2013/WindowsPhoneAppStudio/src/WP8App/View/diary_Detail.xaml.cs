...
{
    /// <summary>
    /// Phone application page for diary_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class diary_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for diary_Detail and all its components.
        /// </summary>
        public diary_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramadiary_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramadiary_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramadiary_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramadiary_Detail(Panoramadiary_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramadiary_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IdiaryCollection>();
				AddHomeAppBarButton();
				...
				((diary_DetailViewModel)DataContext).CurrentdiarySchema = pinnedItem;				
			}
		}
