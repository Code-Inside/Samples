...
{
    /// <summary>
    /// Phone application page for photos_Detail.
    /// </summary>
    [System.Runtime.CompilerServices.CompilerGenerated]
    [System.CodeDom.Compiler.GeneratedCode("Radarc", "4.0")]
    public partial class photos_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for photos_Detail and all its components.
        /// </summary>
        public photos_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramaphotos_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramaphotos_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaphotos_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaphotos_Detail(Panoramaphotos_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaphotos_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Container().Resolve<IphotosCollection>();
				AddHomeAppBarButton();
				...
				((photos_DetailViewModel)DataContext).CurrentphotosCollectionSchema = pinnedItem;				
			}
		}
